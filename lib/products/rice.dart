...
class _RiceScreenState extends State<RiceScreen> {
  ...
  List<ItemsList> Items = [
    ItemsList(quantity: '20 Bags', image: 'jerry.jpeg', price:'N90000', seller:'Bola Jega', item:'rice.jpg'),
    ItemsList(quantity: '52 Bags', image: 'achu.jpeg', price:'N130000', seller:'Chukwuna Eket', item:'rice1.jpg'),
    ItemsList(quantity: '10 Bags', image: 'elisha.jpeg', price:'N480000', seller:'Kenneth Oddo',item:'rice1.jpg'),
    ItemsList(quantity: '35 Bags', image: 'agri.jpeg', price:'N800000', seller:' Nnena Nwabodo', item:'rice.jpg'),
  ];
