...
class BeanScreen extends StatefulWidget {
  const BeanScreen({Key? key}) : super(key: key);
...
class _BeanScreenState extends State<BeanScreen> {
  ...
  List<ItemsList> Items = [
    ItemsList(quantity: '40 Bags', image: 'jerry.jpeg', price:'N50000', seller:'Jerry Akem', item:'beans.jpg'),
    ItemsList(quantity: '12 Bags', image: 'achu.jpeg', price:'N30000', seller:'Achu Agbama', item:'coffee2.jpg'),
    ItemsList(quantity: '20 Bags', image: 'elisha.jpeg', price:'N480000', seller:'Elisha Agbama',item:'coffee3.jpg'),
    ItemsList(quantity: '15 Bags', image: 'agri.jpeg', price:'N410000', seller:' Jessica Olushola', item:'coffee.jpg'),
  ];
